...
export default function HomePage() {
  return (
    <>
      ...
      {/* 03 — Work (editorial archive, Coming Soon) */}
      <ComingSoon
        id="work"
        sceneIndex=""
      ...
      {/* 05 — Expertise (includes S.06 Cinematography as a service) */}
      <Expertise />

      {/* 06 — Process */}
      <ProcessSection />

      {/* 07 — Our Products (Objects / Shop, Coming Soon) */}
      <ComingSoon
        id="objects"
        sceneIndex=""
      ...
      {/* 08 — Design Packages (Coming Soon) */}
      <ComingSoon
        sceneIndex=""
